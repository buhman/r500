...
int load_texture(int fd, const char * path, int texture_size)
{
  int ret;
  ...
  // copy texture
  void * texture_buf = read_file(path);
...
int indirect_buffer()
{
  ...
  const uint32_t vertex_shader[] = {
    #include "../shader_examples/mesa/texture_dual.vs.txt"
  };
  ...
  const uint32_t fragment_shader[] = {
    #include "../shader_examples/mesa/texture_dual.fs.txt"
  };
...
int main()
{
  ...
  struct drm_radeon_cs_reloc relocs[] = {
    ...
    {
      .handle = texturebuffer_handle[0],
      .read_domains = 4, // RADEON_GEM_DOMAIN_VRAM
      .write_domain = 4, // RADEON_GEM_DOMAIN_VRAM
      .flags = 8,
    },
    {
      .handle = texturebuffer_handle[1],
      .read_domains = 4, // RADEON_GEM_DOMAIN_VRAM
      .write_domain = 4, // RADEON_GEM_DOMAIN_VRAM
      .flags = 8,
    },
